...
namespace gInk
{
	public class Hotkey
	{
		//zmienne opisujące klawisz i sprawdzające, czy w skrócie klawiszowym używa się CTRL, ALT, SHIFT lub WinKey
		public int Key;
		public bool Control;
		public bool Alt;
		public bool Shift;
		...
		{
			//walidacja klawisza - prawidłowymi klawiszami wg programu są litery A-Z, cyfry 0-9 oraz cyfry 0-9 na klawiaturze numerycznej
		...
		{
			//funkcja rejestrująca skrót klawiszowy za pomocą tekstu (argument funkcji)
			if (para == "None")
			{
				Key = 0;
				Control = false;
		...
		{
			//sprawdzenie konfliktu z istniejącymi skrótami klawiszowymi, gdy użytkownik próbuje skonfigurować własne w panelu z opcjami
